...
This file exists to clearly separate current documentation from older markdown that still contains pre-refactor language.
...
- `docs/research/index.html`
  Aggregate conversation research report
- `docs/research/conversations/`
  Per-conversation qualitative and structured reports
